...
void DestroyContext(ImNodesContext_Ptr ctx_)
{
    auto ctx = (ImNodesContext*)ctx_;
...
ImNodesContext_Ptr GetCurrentContext() { return GImNodes; }

void SetCurrentContext(ImNodesContext_Ptr ctx) { GImNodes = (ImNodesContext*)ctx; }
