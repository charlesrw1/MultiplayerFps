...
static void ImGui_ImplSDL3_PlatformSetImeData(ImGuiViewport* viewport, ImGuiPlatformImeData* data)
{
    ImGui_ImplSDL3_Data* bd = ImGui_ImplSDL3_GetBackendData();
...
static ImGuiKey ImGui_ImplSDL3_KeyEventToImGuiKey(SDL_Keycode keycode, SDL_Scancode scancode)
{
    ...
    switch (keycode)
    {
        ...
        // F13-F24 + AppBack/AppForward absent in imgui 1.89.4 — see [[rendering/sdl3_migration]]
        case SDLK_AC_BACK:
...
static bool ImGui_ImplSDL3_Init(SDL_Window* window, SDL_Renderer* renderer, void* sdl_gl_context)
{
    ...
    io.SetPlatformImeDataFn = ImGui_ImplSDL3_PlatformSetImeData;
