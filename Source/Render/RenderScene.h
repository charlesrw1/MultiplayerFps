...
public:
	...
	uint16_t register_compact_batch(Model* m, MaterialInstance* mat, int capacity, bool is_dynamic,
									 bool casts_shadow = true) override;
	...
	void set_compact_casts_shadow(uint16_t batch_id, bool casts_shadow) override;
