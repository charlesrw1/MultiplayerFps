...
#define GAME_TEST(name, timeout, fn) static TestRegistrar _reg_##fn((name), (timeout), TestMode::Game, (fn))

#define EDITOR_TEST(name, timeout, fn) static TestRegistrar _reg_##fn((name), (timeout), TestMode::Editor, (fn))
