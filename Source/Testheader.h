...
public:
	...
	REF static void do_something() { printf("doing something\n"); }
	REF static ClassWithDelegate* get_class() { return &myClass; }

	REF static int get_int() { return 10; }
