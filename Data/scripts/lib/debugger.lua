-- Locates the installed actboy168.lua-debug VS Code extension and loads its
-- bundled script/debugger.lua. Copied verbatim from lua-debug's
-- examples/attach/debugger.lua (https://github.com/actboy168/lua-debug).
